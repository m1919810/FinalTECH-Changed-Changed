        ...
        for (int slot : this.getInputSlot()) {
            ...
            if (operation == null) {
                ...
                if(operation.getType() == ItemSerializationConstructorOperation.COPY_CARD){
                    config.setValue(this.blockStorageItemKey, ItemStackUtil.itemStackToString(((ItemCopyCardOperation) operation).getMatchItem()));
                    //BlockStorage.addBlockInfo(location, );
                }
...
//
//            }
            config.setValue(this.blockStorageAmountKey, String.valueOf((int) ((ItemCopyCardOperation) operation).getCount()));
           // BlockStorage.addBlockInfo(location, );
        }
