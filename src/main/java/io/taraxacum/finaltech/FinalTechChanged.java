...
public class FinalTechChanged extends JavaPlugin implements SlimefunAddon {
    ...
    private static PluginInitialization pluginInitialization;
    ...
    public void onEnable() {
        ...
        instance = this;
        pluginInitialization = new PluginInitialization(this,"FinalTECH-Changed")
                .displayName("FinalTECH-Changed")
                .onEnable()
                .cast(PluginInitialization.class)
        ;
        /* read config file */
        try {
        ...
        if (!this.asyncSlimefunPluginSet.isEmpty() || !this.asyncSlimefunIdSet.isEmpty()) {
